...
import { EmailFilters, SentEmail } from '@/services/emailMarketingService';
...
export default function SentEmailsPage() {
  ...
  // View email content
  const viewEmail = async (email: SentEmail) => {
  ...
  const handleFilterChange = (field: keyof EmailFilters, value: string) => {
